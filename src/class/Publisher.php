...
class Publisher {	
	...
	public function listPublisher(){		
		...
		while ($publisher = $result->fetch_assoc()) { 				
			...
			$rows[] = '<button type="button" name="update" id="'.$publisher["publisherid"].'" class="btn btn-warning btn-xs update"><span class="glyphicon glyphicon-edit" title="Edit">Edit</span></button>';
			$rows[] = '<button type="button" name="delete" id="'.$publisher["publisherid"].'" class="btn btn-danger btn-xs delete" ><span class="glyphicon glyphicon-remove" title="Delete">Delete</span></button>';
			$records[] = $rows;
			$count++;
		}
